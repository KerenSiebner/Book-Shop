...
function renderBooks() {
    ...
    <td  value="${book.id}"><button class="read-btn btn btn-light" data-trans="read" onclick="onReadBook('${book.id}')">Read</button ></td>
    <td  value="${book.id}"><button class="update-btn btn btn-light" data-trans="update" onclick="onUpdateBook('${book.id}')">Update</button></td>
    <td  value="${book.id}"><button class="delete-btn btn btn-light" data-trans="delete" onclick="onDeleteBook('${book.id}')">Delete</button></td>
    </tr> `
    )
